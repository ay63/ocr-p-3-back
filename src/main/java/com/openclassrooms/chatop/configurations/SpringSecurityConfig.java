...
public class SpringSecurityConfig {
     ...
     * It then creates an instance of RSAPublicKey using the decoded data and key specification.
     *
     * @return RSAPublicKey
     * @throws Exception
     */
     ...
     * Then decodes the key from its Base64 format.
     * It then creates an instance of  RSAPrivateKey using the decoded data and key specification.
     *
